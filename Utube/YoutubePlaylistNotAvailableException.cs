...
namespace Utube
{
    ...
    public class YoutubePlaylistNotAvailableException : Exception
    {
        ...
        /// </summary>
        public YoutubePlaylistNotAvailableException() : base()
        {
            // Space
        }
        ...
        /// </param>
        public YoutubePlaylistNotAvailableException(string message) : base(message)
        {
            // Space
        }
        ...
        private readonly YoutubePlaylist _playlist;
